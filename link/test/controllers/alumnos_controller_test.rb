...
class AlumnosControllerTest < ActionController::TestCase
  ...
  test "should create alumno" do
    assert_difference('Alumno.count') do
      post :create, alumno: { apellido: @alumno.apellido, asignatura_id: @alumno.asignatura_id, matricula: @alumno.matricula, nombre: @alumno.nombre }
    end
  ...
  test "should update alumno" do
    patch :update, id: @alumno, alumno: { apellido: @alumno.apellido, asignatura_id: @alumno.asignatura_id, matricula: @alumno.matricula, nombre: @alumno.nombre }
    assert_redirected_to alumno_path(assigns(:alumno))
  end
