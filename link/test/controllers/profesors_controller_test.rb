...
class ProfesorsControllerTest < ActionController::TestCase
  ...
  test "should create profesor" do
    assert_difference('Profesor.count') do
      post :create, profesor: { direccion: @profesor.direccion, nombre: @profesor.nombre, profesion: @profesor.profesion }
    end
  ...
  test "should update profesor" do
    patch :update, id: @profesor, profesor: { direccion: @profesor.direccion, nombre: @profesor.nombre, profesion: @profesor.profesion }
    assert_redirected_to profesor_path(assigns(:profesor))
  end
